...
const PaymentModal = ({
  ...
  const currentService = servicePricing[service] || {
    price: amount,
    currency: currency,
  };
    ...
    try {
      ...
      const handler = window.PaystackPop.setup({
        key:
          ...
          "pk_test_0123456789abcdef0123456789abcdef01234567",
    ...
    try {
      if (walletType === "metamask") {
        ...
        const transactionParameters = {
          to:
            import.meta.env.VITE_CRYPTO_WALLET_ADDRESS ||
            "0x742d35Cc6634C0532925a3b8D8e6db6FF7e5b4e2",
          from: accounts[0],
  ...
  const handlePaymentSuccess = async (response, method) => {
    ...
    try {
      ...
      alert(
        "Payment was processed but confirmation failed. Please contact support with your transaction details.",
      );
    } finally {
      setIsProcessing(false);
    }
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">
                  Your payment is protected by industry-standard encryption and
                  security measures. All transactions are processed securely
