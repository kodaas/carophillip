  ...
  const healthTips = [
    {
      ...
      category: 'medication',
      excerpt: 'Learn why medication adherence is crucial for treatment success and how to maintain consistency.',
      content: 'Taking medications exactly as prescribed by your healthcare provider is one of the most important factors in successful treatment. This means taking the right dose, at the right time, for the right duration.',
      readTime: '3 min read',
    ...
    },
    {
      ...
      category: 'nutrition',
      excerpt: 'Discover nutrient-rich foods that support cardiovascular health and reduce heart disease risk.',
      content: 'A heart-healthy diet can significantly reduce your risk of cardiovascular disease. Focus on foods rich in omega-3 fatty acids, fiber, and antioxidants.',
      readTime: '5 min read',
    ...
    },
    {
      ...
      excerpt: 'Effective strategies to manage daily stress and improve your overall mental wellbeing.',
      content: 'Chronic stress can negatively impact your physical and mental health. Learning effective stress management techniques is essential for maintaining overall wellness.',
      readTime: '4 min read',
    ...
    },
    {
      ...
      category: 'exercise',
      excerpt: 'How regular physical activity can transform your health and increase longevity.',
      content: 'Regular exercise is one of the most powerful tools for maintaining good health. It benefits your heart, brain, bones, and overall quality of life.',
      readTime: '6 min read',
    ...
    },
    {
      ...
      category: 'medication',
      excerpt: 'What you need to know about how medications can interact with each other and with food.',
      content: 'Drug interactions occur when one medication affects how another medication works. Understanding these interactions is crucial for safe medication use.',
      readTime: '4 min read',
      author: 'Dr. Caroline Phillips',
      date: '2024-01-05',
      image: '/api/placeholder/600/400',
    ...
    },
    {
      ...
      category: 'prevention',
      excerpt: 'Natural ways to strengthen your immune system and prevent illness.',
      content: 'A strong immune system is your best defense against illness. Learn natural strategies to boost your immunity through lifestyle choices.',
      readTime: '5 min read',
      author: 'Sarah Johnson, PharmD',
      date: '2024-01-03',
      image: '/api/placeholder/600/400',
    ...
    },
    {
      ...
      category: 'wellness',
      excerpt: 'How quality sleep affects your health and tips for better sleep hygiene.',
      content: 'Quality sleep is essential for physical recovery, mental clarity, and overall health. Poor sleep can lead to numerous health problems.',
      readTime: '4 min read',
      author: 'Dr. Michael Chen',
      date: '2024-01-01',
      image: '/api/placeholder/600/400',
    ...
    },
    {
      ...
      category: 'wellness',
      excerpt: 'Understanding proper hydration and its impact on your health and wellbeing.',
      content: 'Proper hydration is crucial for virtually every bodily function. Learn how to maintain optimal hydration levels throughout the day.',
      readTime: '3 min read',
      author: 'Dr. James Martinez',
      date: '2023-12-28',
      image: '/api/placeholder/600/400',
    ...
    },
    {
      ...
      category: 'nutrition',
      excerpt: 'Why vitamin D is essential for your health and how to ensure adequate levels.',
      content: 'Vitamin D plays a crucial role in bone health, immune function, and overall wellbeing. Many people have insufficient levels without knowing it.',
      readTime: '4 min read',
      author: 'Sarah Johnson, PharmD',
      date: '2023-12-25',
      image: '/api/placeholder/600/400',
    ...
    },
    {
      ...
      category: 'prevention',
      excerpt: 'Effective strategies to prevent cold and flu infections during peak seasons.',
      content: 'Prevention is always better than treatment. Learn proven strategies to reduce your risk of catching cold and flu viruses.',
      readTime: '5 min read',
      author: 'Dr. Caroline Phillips',
      date: '2023-12-22',
      image: '/api/placeholder/600/400',
        ...
        <div className="container-apple">
          ...
          >
            ...
            <p className="text-xl md:text-2xl opacity-90 leading-relaxed mb-8">
              Expert advice and practical tips to help you live a healthier, happier life from our team of healthcare professionals.
            </p>
        ...
        <section className="py-16">
          <div className="container-apple">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Featured Health Tips</h2>
        ...
        <div className="container-apple">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold text-gray-800">
              {activeCategory === 'all' ? 'All Health Tips' : categories.find(cat => cat.id === activeCategory)?.name + ' Tips'}
            </h2>
            <p className="text-gray-600">{filteredTips.length} articles found</p>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredTips.map((tip, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-800 mb-3 line-clamp-2">{tip.title}</h3>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      {tip.tags.length > 2 && (
                        <span className="text-gray-400 text-xs">+{tip.tags.length - 2} more</span>
                      )}
                    </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-primary-800 text-white">
        <div className="container-apple">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold mb-6">Stay Updated with Health Tips</h2>
            <p className="text-xl mb-8 opacity-90">
              Subscribe to our newsletter and get the latest health tips, medication updates, and wellness advice delivered to your inbox.
            </p>
      ...
      <section className="py-16">
        <div className="container-apple">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Quick Daily Health Tips</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="container-apple">
          ...
          >
            <div className="flex items-center justify-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-red-800">Important Health Reminders</h2>
            </div>

            <div className="bg-white rounded-2xl p-8 shadow-apple">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold text-red-800 mb-3">When to Seek Immediate Medical Attention:</h3>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-red-700">
                    ...
                    <p><strong>Our Emergency Line:</strong> +1 (555) 911-HELP</p>
